...
public class GameActivity extends MyBaseActivity
{
    ...
    public void setHanzi()
    {
        if (MyApplication.PLAY_TYPE_CHUANGGUAN == curPlayType)
        {
            ...
            if (curData == null)
            {
                ...
                dialog.setTitle("提示");
                dialog.setNegativeButton("尝试其他模式", new DialogInterface.OnClickListener()
                {
        ...
        if (isMore20)
        {
            ...
            dialog.setPositiveButton("好的", new DialogInterface.OnClickListener()
            {
                ...
                public void onClick(DialogInterface dialog, int which)
                {
                    ...
                    {
                        dialog.dismiss();
                        Toast.makeText(GameActivity.this, "您的游戏币不足20个",
    ...
    {
        if (DataUtil.getInfoFromShared(GameActivity.this, "isShowAD") == 1)
        {
            if (random.nextInt(5) > 2)
            {
                AppConnect.getInstance(GameActivity.this)
                        .showPopAd(GameActivity.this);
            }
        }

        MobclickAgent.onEvent(GameActivity.this, "100");
        ...
        if (isRight)
        {
            dialog.setNegativeButton("下一个", new DialogInterface.OnClickListener()
            {
        ...
        else
        {
            ...
            dialog.setPositiveButton("正确答案", new DialogInterface.OnClickListener()
            {
    ...
    private void showAnswer()
    {
        if (DataUtil.g_wenzibi - 50 >= 0)
        {
            ...
            Toast.makeText(GameActivity.this, "正确答案已经显示。", Toast.LENGTH_SHORT)
                    .show();
            changeWenZiBi(-50);
        }
        else
    ...
    public void onVoice(View view)
    {
            ...
            dialog.setPositiveButton(getString(R.string.dialog_confirm_button),
                    new DialogInterface.OnClickListener()
                    {
                                ...
                                int i)
                        {
                            ...
                            processInstall(GameActivity.this, url, assetsApk);
                        }
                    }
            );
        ...
        // 设置你申请的应用appid
        SpeechUtility.getUtility(GameActivity.this).setAppid("5244f7f4");
    ...
    public void onResume()
    {
        ...
        if (DataUtil.getInfoFromShared(GameActivity.this, "wenzibi") > 0)
        {
            AppConnect.getInstance(this)
                    .awardPoints(DataUtil.getInfoFromShared(GameActivity.this,
    ...
    public void onJumpNext(View view)
    {
        ...
        MobclickAgent.onEvent(GameActivity.this, "106");
        setHanzi();
    }

    public void onShowOne(View view)
    {
        MobclickAgent.onEvent(GameActivity.this, "103");
        onZhengQue();
    }
    ...
    public void onFriendHelp(View view)
    {
        ...
        String file = ScreenShot.shoot(this);
        if (TextUtils.isEmpty(file))
        {
            Util.shareSomethingText(this, "分享",
                    "我使用  #汉字听写#  谁能告诉我 " + curData.pinyin + " 这个词语怎么写？");
        }
        else
        {
            Util.shareSomethingTextPhoto(this, "分享",
