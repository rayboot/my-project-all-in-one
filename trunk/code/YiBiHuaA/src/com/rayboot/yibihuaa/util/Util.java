package com.rayboot.yibihuaa.util;
...
public class Util {
	...
	public static String getInfoFromShared(Context context, String key) {
		SharedPreferences preferences = context.getSharedPreferences("qchong",
