package com.rayboot.letsball.msgpush;
...
import com.rayboot.letsball.IndexActivity;
...
public class PushMessageReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if (intent.getAction().equals(PushConstants.ACTION_MESSAGE)) {
			...
			// intent.getExtras().getString(CUSTOM_KEY);
			...
			// responseIntent.putExtra(PushDemoActivity.RESPONSE_METHOD,
			// method);
			// responseIntent.putExtra(PushDemoActivity.RESPONSE_ERRCODE,
			// errorCode);
			// responseIntent.putExtra(PushDemoActivity.RESPONSE_CONTENT,
			// content);
			// responseIntent.setClass(context, PushDemoActivity.class);
			// responseIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
			// context.startActivity(responseIntent);
